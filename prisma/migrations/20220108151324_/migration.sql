...
-- AddForeignKey
ALTER TABLE "courses_modules" ADD CONSTRAINT "courses_modules_fk_id_model_fkey" FOREIGN KEY ("fk_id_model") REFERENCES "modules"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
